...
def analyze_image_with_gemini(image_path: Path, model_name: str, api_key: str) -> Dict:
    # Model name is retained for compatibility; default pipeline uses Ollama OCR model.
    selected_model = "deepseek-ocr"
...
def main() -> None:
    ...
    parser.add_argument("--api-key", default="", help="Unused in Ollama mode; kept for compatibility")
